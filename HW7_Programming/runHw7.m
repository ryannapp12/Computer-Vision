...
search_half_window_size = 10;   % Half size of the search window
template_half_window_size = -1; % Half size of the template window
...
tracking_params.rect = [192 60 43 137];
...
% to specify the target of interest
% tracking_params.rect = chooseTarget(data_params);
tracking_params.rect = [144 116 63 71];
...
% to specify the target of interest
% tracking_params.rect = chooseTarget(data_params);
tracking_params.rect = [110 112 47 123];

% Half size of the search window
tracking_params.search_half_window_size = 6;
% Number of bins in the color histogram
